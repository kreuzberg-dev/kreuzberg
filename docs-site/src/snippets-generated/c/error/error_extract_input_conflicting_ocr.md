...
int main(void) {
    ...
    FILE *input_file_0 = fopen("test_documents/text/fake_text.txt", "rb");
    ...
    free(input_json_0);
    XBERGExtractionConfig* config_handle = xberg_extraction_config_from_json("{\"disable_ocr\":true,\"force_ocr\":true}");
