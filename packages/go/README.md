...
go get github.com/xberg-io/xberg/packages/go@v1.0.0-rc.39
```
...
curl -LO https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.39/go-ffi-linux-x86_64.tar.gz
