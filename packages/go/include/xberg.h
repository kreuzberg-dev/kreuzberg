 ...
 * though â every chunk under the same section repeats the same heading tokens, so a
 ...
 * pipelines can use to exclude or down-weight heading tokens directly â instead of the
 ...
 * `Content` already does â a third variant would be a synonym, and one that every
