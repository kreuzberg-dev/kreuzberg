...
// alef:hash:8753204718107f83debb235844c9d2eabca509ccc97c0be09f75dab8d3962112
...
public sealed record PageContent {
  ...
  /// <summary>
  /// Aggregate OCR confidence for this page. `None` when the page was not
  /// OCR'd.
  /// </summary>
  [JsonPropertyName("ocr_confidence")]
  public PageOcrConfidence
      ? OcrConfidence {
          get; init;
        } = null;
