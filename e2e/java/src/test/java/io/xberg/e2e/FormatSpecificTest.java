...
// alef:hash:03d888e5c7f93f633e0b329aa233c1e12fe9b567c718b3b5b5785378263c8b67
...
assertTrue(result.results().get(0).content().length() >= 20, "expected length >= 20");assertTrue(result.results().get(0).content().contains("$"), "expected to contain: " + "$");
